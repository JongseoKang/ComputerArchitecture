...
public:
  ...
  virtual void advanceCycle()
  {
    ...
    {
      unsigned long wr = _iWriteRegister->to_ulong();
      if(wr)
        _registers[wr] = *_iWriteData;
      else
        _registers[0].reset();
    }
    else
    {
      unsigned long rs = _iReadRegister1->to_ulong();
      unsigned long rt = _iReadRegister2->to_ulong();
      *_oReadData1 = _registers[rs];
      *_oReadData2 = _registers[rt];
    }
  }
